      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 py-8 space-y-12">
        ...
        <div className="text-center space-y-3">
          ...
          <p className={`max-w-2xl mx-auto text-sm sm:text-base ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
            Explore our expanding suite of contribution art planners, real history visualizers, profile badge generators, and automation tools.
          </p>
        </div>
        ...
        <div id="art-studio" className="pt-8 border-t border-slate-800/60 space-y-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl font-bold">Tool #1: Contribution Art Studio & Canvas Planner</h2>
